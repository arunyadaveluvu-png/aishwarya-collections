...
const Hero = () => {
    ...
    return (
        <section className="hero-section" style={{
            ...
            background: 'linear-gradient(rgba(0,0,0,0.15), rgba(0,0,0,0.15)), url("https://vivaahasilks.com/cdn/shop/files/DSC09513Kanchi_Pattu_Saree_2048x.webp?v=1751467807") center/cover no-repeat'
        }}>
